...
/**
 * Reads bits from a file, one at a time. Assumes that the last byte of the file
...
public class BitReader {
     ...
     * @throws IOException
     */
    public BitReader(String file) throws IOException {
    ...
    /**
     * Reads a bit and returns it as a 0 or a 1. Returns -1 when all bits have
     * been returned
     * 
